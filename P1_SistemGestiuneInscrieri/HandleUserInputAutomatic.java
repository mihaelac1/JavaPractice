...
public class HandleUserInputAutomatic {
...
//    }
    ...
    public static void nextLine(Scanner inputScanner){
        System.out.println(inputScanner.nextLine());
    }
    public static int inputMaxParticipants(Scanner inputScanner){
        System.out.println("Bun venit! Introduceti numarul de locuri disponibile: ");

        int maxParticipants = inputScanner.nextInt();
    ...
    public static String login(Scanner inputScanner) {
        while (true) {
    ...
    public static String inputFirstName(Scanner inputScanner){
    ...
    public static String inputLastName(Scanner inputScanner){
    ...
    public static String inputEmail(Scanner inputScanner){
    ...
    public static String inputPhoneNumber(Scanner inputScanner){
    ...
    public static String fieldToUpdate(Scanner inputScanner){
        while (true) {
    ...
    public static String waitCommand(Scanner inputScanner){
    ...
    public static String inputSearch(Scanner inputScanner){
